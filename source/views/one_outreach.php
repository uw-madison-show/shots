...
$my_outreaches = outreachFetch( array($this_id) );

$all_html = '';

if (!empty($my_outreaches)){
  foreach ($my_outreaches as $outreach_id => $data) {
    if (empty($data)){
      $all_html = "No records found.";
    } else {
      foreach ($data as $key => $value) {
        $html = outreachCreateFieldHtml($key, $value);
        $all_html .= $html;
      }
      // add a delete button
...
$related_entities = relationshipsFetch('outreach', $outreach_id, 'php');
  ...
  <div class="row">
    <div id="main-entity" class="col-md-8">
      <div class="form-horizontal">
        <div class="record" data-entity-name="outreach">
          <div class="fields">
          <?php echo $all_html; ?>
          </div>
          <div id="upload-area">
