 ...
 *
 * @param string $target This is one of entity, page, report, relationship, ~~setting~~ internals. The target determines which of the other paramters are optional or required.
 ...
 * @param string $table When the target is one of [ entity | report | relationship ] this param is required. It denotes the database table name that will be acted upon.
...
// TODO maybe get rid of 'setting' to be replaced by 'internals'
