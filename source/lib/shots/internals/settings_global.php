...
$servers['development'] = array('127.0.0.1', 'localhost');
$servers['test']        = array('wwwtest.show.wisc.edu');
$servers['production']  = array('show.wisc.edu');

// this will pick out the server type
$server_type = 'development';
if ( in_array($_SERVER['SERVER_NAME'], $servers['development']) ){
  $server_type = 'development';
} else if ( in_array($_SERVER['SERVER_NAME'], $servers['test']) ){
  $server_type = 'test';
} else if ( in_array($_SERVER['SERVER_NAME'], $servers['production']) ){
