...
if ( $table_exists ){
  ...
  $table->addColumn('outreach_id',     'integer', array('columnDefinition' => 'INTEGER PRIMARY KEY AUTOINCREMENT')); 
  $table->addColumn('primary_contact', 'string',  array('notnull' => false));
  $table->addColumn('department',      'string',  array('notnull' => false));
  $table->addColumn('resource',        'string',  array('notnull' => false));
  $table->addColumn('show_lead',       'string',  array('notnull' => false));
